...
std::size_t Image::getWidth() const { return imageHandle.width; }

std::size_t Image::getHeight() const { return imageHandle.height; }

std::span<const std::byte> Image::getPixels() const { return std::span{imagePixels.begin(), imagePixels.end()}; }

GLFWimage *Image::getHandle() { return &imageHandle; }

const GLFWimage *Image::getHandle() const { return &imageHandle; }
